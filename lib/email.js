  ...
  const dealCardsHtml = deals.map(deal => {
    ...
    <div style="background-color: #1e293b; border: 1px solid #334155; border-radius: 12px; padding: 20px; margin-bottom: 16px; font-family: 'Segoe UI', Arial, sans-serif;">
      ...
      <div style="display: flex; gap: 8px; margin-top: 14px; flex-wrap: wrap;">
        <a href="${deal.bookingLinks.googleFlightsUrl}" target="_blank" rel="noopener noreferrer" style="background-color: #3b82f6; color: #ffffff; text-decoration: none; font-weight: bold; font-size: 12px; padding: 8px 14px; border-radius: 6px; display: inline-block;">
          ✈️ Google Flights
        </a>
        <a href="${deal.bookingLinks.skyscannerUrl}" target="_blank" rel="noopener noreferrer" style="background-color: #0284c7; color: #ffffff; text-decoration: none; font-weight: bold; font-size: 12px; padding: 8px 14px; border-radius: 6px; display: inline-block;">
          🔍 Skyscanner
        </a>
        <a href="${deal.bookingLinks.makeMyTripUrl || '#'}" target="_blank" rel="noopener noreferrer" style="background-color: #e11d48; color: #ffffff; text-decoration: none; font-weight: bold; font-size: 12px; padding: 8px 14px; border-radius: 6px; display: inline-block;">
          🧳 MakeMyTrip
        </a>
      </div>
    </div>
